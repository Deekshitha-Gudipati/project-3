...
s['timestamp_num'] = s['timestamp'].view('int64') // 10**9
...
if len(devices) > 1:
    ...
    recommendations.append(f"🛠 Highest energy-consuming devices: {rec_devices}. Consider optimizing or upgrading them.")
...
if question:
    ...
    if "peak" in question_lower:
        ...
        st.write(f"🛠 Highest energy-consuming devices: {rec_devices}. Consider checking these for optimization.")
